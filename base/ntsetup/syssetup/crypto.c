...

{
    ...
    if(TestCertName) {
        ...
        if(!hStore) {
            ...
            //
            DWORD i;
            BYTE arHashData[2][20] = { {0x8D, 0x19, 0xCC, 0xCE, 0xDD, 0xAF, 0x2F, 0x4C, 0xBE, 0x90, 0xC8, 0x92, 0x7C, 0x08, 0xA1, 0xF8, 0x4A, 0xE4, 0x1B, 0xC5} }; // current beta testroot.cer (also used for OEM testsigning)
